...
export default function Home() {
  ...
  const devWallets = [
    "0x28Db17501913fB126b33347f0AC77d3828578EA9",
      ...
      if (res.ok) {
        ...
        if (data) {
          ...
          localStorage.setItem(
            "discord_username",
            onboardingData?.discordUsername || "discord auth",
          );
          ...
          <div className="max-w-2xl mx-auto space-y-6">
            {!isAllowed && (
              <Card className="align-center items-center justify-center">
                <CardHeader>
                  <CardTitle className="">
                    Connect your wallet to enter AudataDAO app
                  </CardTitle>
                </CardHeader>
              </Card>
            )}
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Navigation discordUsername={onboardingData?.discordUsername || null} />
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <Card className="flex-1 overflow-x-hidden space-y-4 p-4 h-full">
            <CardHeader>
              ...
              <CardDescription>
                Top 30 of our uploaders of all time
              </CardDescription>
